...
> 📌 參考原版研究資料：`.agent/research/zhao_yun_vs_adou_research.md`
> 開發方向以對齊「赵云与阿斗」核心玩法為準，非 APK 打包。

### 🔴 P0｜本次衝刺（MVP 前必完成）

| # | 功能 | 規模 | 說明 | 狀態 |
|---|------|------|------|------|
| P0-1 | 武將拼字召喚邏輯 | 中 | 相鄰字牌齊全→金框激活，solo 打瞌睡 | ✅ 已完成 |
| P0-2 | 武將技能（T0三將） | 大 | pierce/area/single 三種，每3次攻擊觸發 | ✅ 已完成 |
| P0-3 | 農民被動道具 | 小 | 放入道具槽後每3秒+1糧食，解決後期資源荒 | ✅ 已完成 |

### 🟡 P1｜v1.0 前完成

| # | 功能 | 規模 | 說明 | 狀態 |
|---|------|------|------|------|
| P1-1 | 道具槽系統框架 | 中 | UI 加主動2槽+被動6槽，征兵池加入道具概率 | ✅ 已完成 |
| P1-2 | 洛陽鏟 + 摸金校尉道具 | 小 | 洛陽鏟：每60s+1鏟子；摸金：開格送10糧食 | 🔴 未開始 |
| P1-3 | Boss 迷惑技能 | 小 | 第6波Boss施放迷惑，周圍我方單位停攻2秒 | 🔴 未開始 |
| P1-4 | 看廣告流程 | 中 | 危險時看廣告 → 召喚援軍盾兵消滅當波敵軍 | 🔴 未開始 |
| P1-5 | 阿斗血量確認為3 | 極小 | kJiangInitialHp=3 | ✅ 已確認 |

### ⚪ P2｜v1.0 後

| # | 功能 | 說明 |
|---|------|------|
| P2-1 | 地圖/關卡系統 | 淞滬/徐蚌/遼瀋/平津/渡江，不同格子布局 |
| P2-2 | 段位/軍銜系統 | 積星晉升，勝負扣加星 |
| P2-3 | 攻速符道具 | 疊加攻速，高風險高回報 |
| P2-4 | 音效 | 攻擊/升級/波次音效 |
...
| 日期 | 變更內容 | 相關檔案 | 說明 |
|------|---------|---------|------|
| 2026-06-29 | **P1-1 道具槽框架 + P0-3 農民被動道具** | `config.dart`, `models.dart`, `game_notifier.dart`, `tower_defense_game.dart`, `hand_cards.dart` | ItemDef/ItemCard 新型別；道具槽主動2+被動6；農民5%征兵概率；拖手牌道具→槽放入；引擎每3秒呼叫farmerTick()+1糧食 |
